 ...
 */
public class UnsafeContractForLocalObjDemo {
    private static UnsafeSequence memberUnsafeSequence = new UnsafeSequence();


    public static void main(String[] args) {
        Runnable runnable = () -> {
            UnsafeSequence unsafeSequence = memberUnsafeSequence;
            try {
                for (int i = 0; i < 10; i++) {
                    unsafeSequence.incr();
